...
CREATE TABLE IF NOT EXISTS flow_logs (
    ...
    flow_direction VARCHAR(20) NOT NULL DEFAULT 'unknown',
    internal_device_ip VARCHAR(50),
    external_endpoint_ip VARCHAR(50),
    session_id CHAR(40),
    application VARCHAR(50) NOT NULL DEFAULT 'Other',
    agent_id VARCHAR(100),
    analysis_source VARCHAR(64) NOT NULL DEFAULT 'transport_fallback',
    analysis_confidence FLOAT NOT NULL DEFAULT 0.0,
    analysis_signals_json TEXT,
    ingest_hash CHAR(40),
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    ...
    INDEX idx_flow_logs_direction_last_seen (flow_direction, last_seen),
    INDEX idx_flow_logs_confidence_last_seen (analysis_confidence, last_seen),
    UNIQUE KEY uq_flow_logs_ingest_hash (ingest_hash),
