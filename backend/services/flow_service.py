...
class FlowService:
    ...
    async def buffer_flows(self, flows: list) -> bool:
        ...
        try:
            ...
            # Expose metrics
            try:
                from backend.middleware.prometheus_middleware import FLOWS_INGESTED_TOTAL
            ...
            while True:
                ...
                if use_redis:
                    ...
                    try:
                        ...
                        try:
                            from backend.middleware.prometheus_middleware import REDIS_STREAM_LENGTH, REDIS_CONSUMER_LAG
    ...
    def _persist_batch_on_connection(self, conn, cursor, batch) -> list[tuple[str, dict]]:
        ...
        for org_id, sanitized in sanitized_batch:
            ...
            if should_emit_alert:
                ...
                try:
                    from backend.middleware.prometheus_middleware import ALERTS_GENERATED
