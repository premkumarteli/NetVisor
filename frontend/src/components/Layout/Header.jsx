  ...
  return (
    <header className="nv-topbar">
      <div className="nv-topbar__cluster">
        <button type="button" className="nv-button nv-button--secondary" onMouseEnter={playHoverSound} onClick={onToggleNav}>
      ...
      <div className="nv-topbar__cluster">
        ...
        <button type="button" className="nv-button nv-button--secondary" onMouseEnter={playHoverSound} onClick={onToggleAlerts} title="Threat feed">
          <i className="ri-notification-3-line"></i>
        </button>
        <div className="nv-theme-switcher" ref={themeMenuRef}>
          <button type="button" className="nv-button nv-button--secondary nv-theme-trigger" onMouseEnter={playHoverSound} onClick={() => setThemeMenuOpen((curr) => !curr)} title="Workspace Mode">
        ...
        <div style={{ position: 'relative' }} ref={menuRef}>
          <button type="button" className="nv-user-pill" onMouseEnter={playHoverSound} onClick={() => setMenuOpen((current) => !current)}>
          ...
          {menuOpen ? (
            <div className="nv-menu">
              ...
              {isAdmin ? (
                <button type="button" className="nv-menu__item" onMouseEnter={playHoverSound} onClick={() => navigate('/settings')}>
              ...
              <button type="button" className="nv-menu__item" onMouseEnter={playHoverSound} onClick={handleLogout}>
