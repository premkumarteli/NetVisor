...
const DeepSpace = () => {
  ...
  useEffect(() => {
    if (performanceTier === 'minimal') return; // Skip heavy rendering
    ...
    const init = () => {
      stars = [];
      asteroids = [];
      const particleCount = performanceTier === 'cinematic' ? 300 : 150;
