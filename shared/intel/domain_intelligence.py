...
SERVICE_MAPPINGS = {
    ...
    "ytimg.com": ("YouTube Assets", "streaming"),
    "googlevideo.com": ("YouTube Video", "streaming"),
    "netflix.com": ("Netflix", "streaming"),
    "nflxvideo.net": ("Netflix Video", "streaming"),
    "nflximg.net": ("Netflix Assets", "streaming"),
    "nflxext.com": ("Netflix", "streaming"),
    "twitch.tv": ("Twitch", "streaming"),
    "vimeo.com": ("Vimeo", "streaming"),
    "facebook.com": ("Facebook", "social"),
    "instagram.com": ("Instagram", "social"),
    "whatsapp.com": ("WhatsApp", "chat"),
    "whatsapp.net": ("WhatsApp", "chat"),
    "telegram.org": ("Telegram", "chat"),
    "telegram.me": ("Telegram", "chat"),
    "t.me": ("Telegram", "chat"),
    "discord.gg": ("Discord", "chat"),
    "discord.com": ("Discord", "chat"),
    "discordapp.com": ("Discord", "chat"),
    ...
    "play.google.com": ("Google Play", "system"),
