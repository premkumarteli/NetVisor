...
SERVICE_MAPPINGS = {
    ...
    "events.data.microsoft.com": ("Microsoft Telemetry", "system"),
    "activity.windows.com": ("Microsoft Telemetry", "system"),
    "googleapis.com": ("Google APIs", "system"),
    "azure.com": ("Azure Services", "system"),
    "applicationinsights.azure.com": ("Microsoft Telemetry", "system"),
    "cloudapp.azure.com": ("Azure Services", "system"),
    "azureedge.net": ("Azure Services", "system"),
    "windows.net": ("Microsoft Telemetry", "system"),
